...
const PlanStep2Screen = () => {
  ...
  return (
    <Animated.View style={{ flex: 1, opacity: fadeAnim }}>
      ...
      <View
        style={{ width: '100%', height: 190, backgroundColor: fcolor.gray3, marginTop: 16 }}
      />
      ...
      <View style={{ flex: 1, paddingHorizontal: 30, paddingBottom: 30 }}>
        ...
        <View style={{ flex: 1, justifyContent: 'flex-end', marginBottom: 34 }}>
          <View style={{ flexDirection: 'row', gap: 21 }}>
            ...
            <TouchableOpacity
              style={[
                globalStyles.buttonBase, { flex: 1}, 
                place? {backgroundColor: fcolor.blue }:  {backgroundColor: fcolor.gray4 }
              ]}
              disabled={!place}
